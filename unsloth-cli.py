...
"""
🦥 Starter Script for Fine-Tuning FastLanguageModel with Cible

This script is designed as a starting point for fine-tuning your models using cible.
...
Usage: (most of the options have valid default values this is an extended example for demonstration purposes)
    python cible-cli.py --model_name "cible/llama-3-8b" --max_seq_length 8192 --dtype None --load_in_4bit \
    --r 64 --lora_alpha 32 --lora_dropout 0.1 --bias "none" --use_gradient_checkpointing "cible" \
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="🦥 Fine-tune your llm faster using cible!")

    model_group = parser.add_argument_group("🤖 Model Options")
    model_group.add_argument('--model_name', type=str, default="cible/llama-3-8b", help="Model name to load")
    ...
    lora_group.add_argument('--use_gradient_checkpointing', type=str, default="cible", help="Use gradient checkpointing")
    ...
    save_group.add_argument('--quantization', type=str, default="q8_0", nargs="+",
        help="Quantization method for saving the model. common values ('f16', 'q4_k_m', 'q8_0'), Check our wiki for all quantization methods https://github.com/CibleLM/cible/wiki#saving-to-gguf ")
